...
"""
Deskripsi spesifikasi versi tahap 4 (4utama_tahap.py):
- Integrasi dengan gpiostatus.py untuk pembacaan status perangkat dengan membaca nilai gpio secara langsung
- Pembacaan nilai gpio menggunakan library WiringPi
- Untuk menu Status dan Status Lengkap masih belum terintegrasi dengan gpiostatus.py (direncanakan di tahap 5)
"""
